        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown  "  >
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown" id="menuc" style="background:-webkit-linear-gradient(left top,#45B39D  ,#FD3030);" >
                    <a class="dropdown-item btn btn-primary  " id="Rg_lib"  href="{{route('Caracteristicas')}}"   ><i class="fas fa-atlas"></i> Caracteristicas </a>
                    <a class="dropdown-item btn btn-primary  " id="Rg_lib"  href="{{route('Ventajas')}}"   ><i class="fas fa-atlas"></i> Ventajas y Desventajas </a>
